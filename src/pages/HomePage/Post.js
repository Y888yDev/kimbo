...
import bgpost from '../../asset/bgs/bg3.jpg'
...
(xp===-100*(5-1))? setXp(0): setXp(xp-100);
    ...
    return (
            ...
            <Grid  container flexGrow="row" id="flxPost" >
    ...
    >
            <Box sx={{ position:'relative',display:'flex',width:'300px',overflow: 'hidden'
                        ...
                        {/* <Box
                            ...
                            ,position:'relative', transition: '0.2s'
                          ,overflow: 'cover'}}> 
                            <ReviewCard sx={{width:'200'}} title={ 'fist'} desc={'nothing yet'} ssrc={bgpdct1} />
                            <ReviewCard sx={{width:'200'}} title={ 'fist'} desc={'nothing yet'} ssrc={bgpdct2} />
                            <ReviewCard sx={{width:'200'}} title={ 'fist'} desc={'nothing yet'} ssrc={bgpdct1} />
                            <ReviewCard sx={{width:'200'}} title={ 'fist'} desc={'nothing yet'} ssrc={bgpdct2} />
                            <ReviewCard sx={{width:'200'}} title={ 'fist'} desc={'nothing yet'} ssrc={bgpdct2} />
